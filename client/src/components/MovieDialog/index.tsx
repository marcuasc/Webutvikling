...
import { closeResultModal, fetchMovie } from "../../redux/result/resultActions";
...
const mapDispatchToProps = (dispatch: ThunkDispatch<any, any, AnyAction>) => {
    return {
        closeResultModal: () => dispatch(closeResultModal()),
...
const MovieDialog: React.FunctionComponent<Props> = (props) => {
    ...
    const movie = props.resultData.result;
    const id = movie._id;
    ...
    return (
        ...
        <Dialog
            ...
            maxWidth="xl"
            color="secondary"
            open={props.resultData.open}
            onClose={props.closeResultModal}
        >
            ...
            <DialogActions>
                {/* MUI Button that runs closeResultModal action */}
                <Button onClick={props.closeResultModal} color="primary">
                    Close
                </Button>
            </DialogActions>
        </Dialog>
